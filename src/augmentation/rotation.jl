...
"""
    rotate!(out::Array{Float32,3}, img::Array{Float32,3}, θ::Real)
...
- `img::Array{Float32,3}` : input image to rotate.
...
"""
function rotate!(out::Array{Float32,3}, img::Array{Float32,3}, θ::Real)
    H, W, C = size(img)
